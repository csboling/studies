...
\maketitle
% TODO:
% 3. Show that $\mathbb{Q}$ is not free.
...
%     $$
      ...
      Since $L$ is discrete, let $\delta > 0$ denote the radius of the
      ...
      Define the fractional-part function $\{ \bullet \} : \mathbb{R}
      ...
      small fractional part, that is, there exists an integer $m$ such that
